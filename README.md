...
---
### Information *[Asymmetry](AAAA)* and *[Cocoons](AAAA)*. -[MyResearch](AAAA)<br/>[Information Guide](AAAA): *[Source](AAAA), [Verify](AAAA), Quality-Value, Using, Learning, Collection, Exchange, Cycle*. -MyResearch<br/>[Aesthetics Guide](AAAA): *Importance, Develop, Source Material Collection Guide.*<br/>All Softwares I [Using](AAAA)/[Used](AAAA)<br/><br/>- *[Simple](https://github.com/VoluntieTsai/Humor)* or *[Ignorant](AAAA)*, a flash of thought. <br/>- Only Talk is cheap, Show me the ____.
