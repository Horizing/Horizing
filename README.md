...
！和纯粹技术不同，没人能告诉我这些的思考是否具有**意义**-请阅读 **[我的局限性](AAAA)** 必须强调**信息差和茧房**存在  
！包括技术衍生的管理学等等部分  
！其中部分问题不愿意、不想、甚至害怕、恐惧去思考这些问题是正常的  
！请**带着怀疑**阅读我的拙作，不要**人云亦云**或**全盘否定**  
⚠️**充分或必要条件**为复杂情况推理的基本原则和结果，因为必须再次强调**信息差和茧房**存在  
...
### Information *[Asymmetry](AAAA)* and *[Cocoons](AAAA)*.<br/> -*[Information Guide](AAAA): [Source](AAAA), [Verify](AAAA), Quality-Value, Using, Learning, Collection, Exchange, Cycle.*<br/>-MyResearch<br/><br/>Courage: *[Not blindly](AAAA)* <br/>Leadership<br/>Responsibility<br/><br/>Aesthetics [Appreciation](AAAA)<br/>-[Aesthetics Guide](AAAA): *Importance, Develop, Source Material Collection Guide.*<br/><br/>Inspiration<br/><br/>Softwares all I [Using](AAAA)/[Used](AAAA)<br/><br/>-- *[Simple](https://github.com/VoluntieTsai/Humor)* or *[Ignorant](AAAA)*, a flash of thought. <br/>-- Only Talk is cheap, Show me the ____.
